...
import os
my_path = '/fslhome/fslcollab151/convergence_mcmc/Results/10000zxz'
print(my_path)
class diagnostics:
...
def li(x):
    ...
    return norm.pdf(u0, z_true, 1.0) * norm.pdf(u1, xz_true, 1.0) 
...
np.savetxt('zxz_x.out',all_samples_x, delimiter=',')
np.savetxt('zxz_y.out',all_samples_y, delimiter=',')
np.savetxt('zxz_z.out',all_samples_y, delimiter=',')
