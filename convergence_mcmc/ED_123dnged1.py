...
import os
my_path = '/fslhome/fslcollab151/convergence_mcmc/Results/123dnged1'
prit(my_path)
class diagnostics:
...
def li(x):
    ...
    return norm.pdf(u0, x_true, 0.5) * norm.pdf(u1, y_true, 0.5) * norm.pdf(u2, z_true, 0.5) * norm.pdf(u3, x2_true, 0.5) * norm.pdf(u4, y2_true, 0.5) * norm.pdf(u5, z2_true, 0.5) * norm.pdf(u6, xy_true, 0.5) * norm.pdf(u7, xz_true, 0.5) * norm.pdf(u8, yz_true, 0.5) * norm.pdf(u9, x3_true, 0.5) * norm.pdf(u10, y3_true, 0.5) * norm.pdf(u11, z3_true, 0.5) * norm.pdf(u12, x2y_true, 0.5) * norm.pdf(u13, x2z_true, 0.5) * norm.pdf(u14, y2x_true, 0.5) * norm.pdf(u15, y2z_true, 0.5) * norm.pdf(u16, z2x_true, 0.5) * norm.pdf(u17, z2y_true, 0.5)
