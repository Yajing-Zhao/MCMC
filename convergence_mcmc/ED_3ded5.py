...
import os
my_path = '/fslhome/fslcollab151/convergence_mcmc/Results/3ded5'
print(my_path)
class diagnostics:
...
def li(x):
    ...
    return norm.pdf(u0, x3_true, np.absolute(x3_true)/10.0) * norm.pdf(u1, y3_true, np.absolute(y3_true)/10.0) * norm.pdf(u2, z3_true, np.absolute(z3_true)/10.0) * norm.pdf(u3, x2y_true, np.absolute(x2y_true)/10.0) * norm.pdf(u4, x2z_true, np.absolute(x2z_true)/10.0) * norm.pdf(u5, y2x_true, np.absolute(y2x_true)/10.0) * norm.pdf(u6, y2z_true, np.absolute(y2z_true)/10.0) * norm.pdf(u7, z2x_true, np.absolute(z2x_true)/10.0) * norm.pdf(u8, z2y_true, np.absolute(z2y_true)/10.0)
