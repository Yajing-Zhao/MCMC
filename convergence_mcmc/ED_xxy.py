...
import os
my_path = '/fslhome/fslcollab151/convergence_mcmc/Results/10000xxy'
print(my_path)
class diagnostics:
...
def li(x):
    ...
    return norm.pdf(u0, x_true, 1.0) * norm.pdf(u1, xy_true, 1.0) 
...
np.savetxt('xxy_x.out',all_samples_x, delimiter=',')
np.savetxt('xxy_y.out',all_samples_y, delimiter=',')
np.savetxt('xxy_z.out',all_samples_y, delimiter=',')
