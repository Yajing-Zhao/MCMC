...
import os
my_path = '/fslhome/fslcollab151/convergence_mcmc/Results/12d'
print(my_path)
class diagnostics:
...
def li(x):
    ...
    return norm.pdf(u0, x_true, 1.0) * norm.pdf(u1, y_true, 1.0) * norm.pdf(u2, z_true, 1.0) * norm.pdf(u3, x2_true, 1.0) * norm.pdf(u4, y2_true, 1.0) * norm.pdf(u5, z2_true) * norm.pdf(u6, xy_true, 1.0) * norm.pdf(u7, xz_true, 1.0) * norm.pdf(u8, yz_true, 1.0)
