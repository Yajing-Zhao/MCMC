...
import os
my_path = '/fslhome/fslcollab151/convergence_mcmc/Results/10000yxy'
print(my_path)
class diagnostics:
...
def li(x):
    ...
    return norm.pdf(u0, y_true, 1.0) * norm.pdf(u1, xy_true, 1.0) 
...
np.savetxt('yxy_x.out',all_samples_x, delimiter=',')
np.savetxt('yxy_y.out',all_samples_y, delimiter=',')
np.savetxt('yxy_z.out',all_samples_y, delimiter=',')
