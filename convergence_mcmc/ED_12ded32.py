...
import os
my_path = '/fslhome/fslcollab151/convergence_mcmc/Results/12ded32'
print(my_path)
class diagnostics:
...
def li(x):
    ...
    return norm.pdf(u0, x_true, x_var) * norm.pdf(u1, y_true, y_var) * norm.pdf(u2, z_true, z_var) * norm.pdf(u3, x2_true, x2_var) * norm.pdf(u4, y2_true, x2_var) * norm.pdf(u5, z2_true, z2_var) * norm.pdf(u6, xy_true, xy_var) * norm.pdf(u7, xz_true, xz_var) * norm.pdf(u8, yz_true, yz_var)
