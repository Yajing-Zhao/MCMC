...
import os
my_path = '/fslhome/fslcollab151/convergence_mcmc/Results/123drefnged3'
print(my_path)
class diagnostics:
...
def li(x):
    ...
    u9=np.mean(states[3]*states[3]*states[3])
    u10=np.mean(states[4]*states[4]*states[4])
    u11=np.mean(states[5]*states[5]*states[5])
    u12=np.mean(states[3]*states[3]*states[4])
    u13=np.mean(states[3]*states[3]*states[5])
    u14=np.mean(states[3]*states[4]*states[4])
    u15=np.mean(states[4]*states[4]*states[5])
    u16=np.mean(states[3]*states[5]*states[5])
    u17=np.mean(states[4]*states[5]*states[5])
    u18=np.mean(states[3]*states[4]*states[5]*states[5])
