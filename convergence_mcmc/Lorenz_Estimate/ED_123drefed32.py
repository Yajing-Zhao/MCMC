...
import os
my_path = '/fslhome/fslcollab151/convergence_mcmc/Results/123drefed32'
print(my_path)
class diagnostics:
...
x_var, y_var, z_var = np.var(states, axis=0)
x2_true = np.mean(states[0]*states[0])
x2_var = np.var(states[0]*states[0])
y2_true = np.mean(states[1]*states[1])
y2_var = np.var(states[1]*states[1])
z2_true = np.mean(states[2]*states[2])
z2_var = np.var(states[2]*states[2])
xy_true = np.mean(states[0]*states[1])
xy_var = np.var(states[0]*states[1])
xz_true = np.mean(states[0]*states[2])
xz_var = np.var(states[0]*states[2])
yz_true = np.mean(states[1]*states[2])
yz_var = np.var(states[1]*states[2])
x3_true = np.mean(states[0]*states[0]*states[0])
x3_var = np.var(states[0]*states[0]*states[0])
y3_true = np.mean(states[1]*states[1]*states[1])
y3_var = np.var(states[1]*states[1]*states[1])
z3_true = np.mean(states[2]*states[2]*states[2])
z3_var = np.var(states[2]*states[2]*states[2])
x2y_true = np.mean(states[0]*states[0]*states[1])
x2y_var = np.var(states[0]*states[0]*states[1])
x2z_true = np.mean(states[0]*states[0]*states[2])
x2z_var = np.var(states[0]*states[0]*states[2])
y2x_true = np.mean(states[0]*states[1]*states[1])
y2x_var = np.var(states[0]*states[1]*states[1])
y2z_true = np.mean(states[1]*states[1]*states[2])
y2z_var = np.var(states[1]*states[1]*states[2])
z2x_true = np.mean(states[0]*states[2]*states[2])
z2x_var = np.var(states[0]*states[2]*states[2])
z2y_true = np.mean(states[1]*states[2]*states[2])
z2y_var = np.var(states[1]*states[2]*states[2])
xyz2_true = np.mean(states[0]*states[1]*states[2]*states[2])
xyz2_var = np.var(states[0]*states[1]*states[2]*states[2])
...
def li(x):
    ...
    u1=np.mean(states[1])
    u2=np.mean(states[2])
    u3=np.mean(states[0]*states[0])
    u4=np.mean(states[1]*states[1])
    u5=np.mean(states[2]*states[2])
    u6=np.mean(states[0]*states[1])
    u7=np.mean(states[0]*states[2])
    u8=np.mean(states[1]*states[2])
    u9=np.mean(states[0]*states[0]*states[0])
    u10=np.mean(states[1]*states[1]*states[1])
    u11=np.mean(states[2]*states[2]*states[2])
    u12=np.mean(states[0]*states[0]*states[1])
    u13=np.mean(states[0]*states[0]*states[2])
    u14=np.mean(states[0]*states[1]*states[1])
    u15=np.mean(states[1]*states[1]*states[2])
    u16=np.mean(states[0]*states[2]*states[2])
    u17=np.mean(states[1]*states[2]*states[2])
    u18=np.mean(states[0]*states[1]*states[2]*states[2])
    return norm.pdf(u0, x_true, x_var) * norm.pdf(u1, y_true, y_var) * norm.pdf(u2, z_true, z_var) * norm.pdf(u3, x2_true, x2_var) * norm.pdf(u4, y2_true, y2_var) * norm.pdf(u5, z2_true, z2_var) * norm.pdf(u6, xy_true, xy_var) * norm.pdf(u7, xz_true, xz_var) * norm.pdf(u8, yz_true, yz_var) * norm.pdf(u9, x3_true, x3_var) * norm.pdf(u10, y3_true, y3_var) * norm.pdf(u11, z3_true, z3_var) * norm.pdf(u12, x2y_true, x2y_var) * norm.pdf(u13, x2z_true, x2z_var) * norm.pdf(u14, y2x_true, y2x_var) * norm.pdf(u15, y2z_true, y2z_var) * norm.pdf(u16, z2x_true, z2x_var) * norm.pdf(u17, z2y_true, z2y_var) * norm.pdf(u18, xyz2_true, xyz2_var)
