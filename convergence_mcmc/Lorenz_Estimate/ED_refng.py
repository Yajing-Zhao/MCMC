...
import os
my_path = '/fslhome/fslcollab151/convergence_mcmc/Results/refng'
print(my_path)
class diagnostics:
...
def li(x):
    ...
    return norm.pdf(u0, z_true, 1.0) * norm.pdf(u1, x2_true, 1.0) * norm.pdf(u2, xy_true, 1.0) * norm.pdf(u3, z2_true, 1.0) * norm.pdf(u4, xyz_true, 1.0) * norm.pdf(u5, z3_true) * norm.pdf(u6, xyz2_true, 1.0)
